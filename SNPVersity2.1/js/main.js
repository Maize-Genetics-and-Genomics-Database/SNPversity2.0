    ...
    function handleDatasetChange(value) {
        ...
        if (value === 'mgdb2026_hq') {
            divM26.style.display = "block";
    ...
    function getCheckedGenotypes(callback) {
        ...
        if (fileInput.files.length > 0) {
            ...
            if (selectedValue === 'mgdb2026_hq' || selectedValue === 'mgdb2026_hc') {

                // Handle the case where no file is uploaded
                var checkboxes = document.querySelectorAll('.genotypes26');
            ...
            */
                ...
                if (selectedValue === 'mgdb2026_hq' || selectedValue === 'mgdb2026_hc') {
                 ...
                 // var checkboxes = document.querySelectorAll('.genotypes26');
                 // checkboxes.forEach(function(checkbox) {
                //    if (checkbox.checked && checkbox.value !== "skip") {

                      // keep only the part after the last "_"
                //      var v = checkbox.value;
                //      var afterLastUnderscore = v.split('_').pop();
...
function openPopupM() {
           var myWindow = window.open("", "MsgWindow", "width=820,height=550");
...
function openPopupM26() {
          var myWindow = window.open("", "MsgWindow", "width=820,height=850");
          myWindow.document.open();
          myWindow.document.write('<html><head><title>MaizeGDB 2026 Accessions Table</title><style>table {width: 800px; border-collapse: collapse; font-family: Arial, sans-serif;} td, th {border-bottom: 3px solid #4CAF50; padding: 10px; background-color: #E8F5E9; font-weight: bold;} tr:nth-child(even) {background-color: #F9FBE7;} div {width: 20px; height: 30px;}</style></head><body>');
          myWindow.document.write(document.getElementById("tableToPopupM26").innerHTML);
          myWindow.document.write('</body></html>');
          myWindow.document.close();
      }
        ...
        if(first_header)
        {
          ...
          headers.forEach((header, headerIndex) => {
              if(headerIndex == 1 && dataset == "maizegdb2026")
              {
                  ...
                  const th9a = document.createElement('th');
                  th9a.innerHTML = "PlantCAD1 score";
                  th9a.className = 'th3'; // Assign the class
                  headerRow.appendChild(th9a);

                  const th9b = document.createElement('th');
                  th9b.innerHTML = "PlantCAD2 score";
                  th9b.className = 'th3'; // Assign the class
                  headerRow.appendChild(th9b);

                  const th10a = document.createElement('th');
                  th10a.innerHTML = "ESM1 score";
                  th10a.className = 'th3'; // Assign the class
                  headerRow.appendChild(th10a);

                  const th10b = document.createElement('th');
                  th10b.innerHTML = "ESM2 score";
                  th10b.className = 'th3'; // Assign the class
                  headerRow.appendChild(th10b);

                  const th10c = document.createElement('th');
                  th10c.innerHTML = "ESM3 score";
          ...
          rowData.forEach((cell, cellIndex) => {
            ...
            if(cellIndex == 7 && dataset == "maizegdb2026")
            {
                ...
                DNA1 = cell.match(/plantcad1_score=([^;]+)/)[1];
                DNA2 = cell.match(/plantcad2_score=([^;]+)/)[1];
                ...
                let AASCORE2 = cell.match(/ESM2_score=([^;]+)/)[1];
                if (AASCORE2 == ".") {
                    AASCORE2 = "N/A"
                }

                let AASCORE3 = cell.match(/ESM3_score=([^;]+)/)[1];
                if (AASCORE3 == ".") {
                    AASCORE3 = "N/A"
                }
                ...
                const td9a = document.createElement('td');
                td9a.innerHTML = DNA1;
                td9a.className = 'td3'; // Assign the class
